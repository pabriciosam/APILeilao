...
builder.Services.AddScoped<GetCurrenteLeilaoUseCase>();
builder.Services.AddScoped<IAuctionRepository, AuctionRepository>();
builder.Services.AddScoped<IOfferRepository, OfferRepository>();
builder.Services.AddScoped<IUserRepository, UserRepository>();
builder.Services.AddScoped<ILoggerUser, LoggerUser>();

builder.Services.AddDbContext<LeilaoDbContext>(options =>
{
    options.UseSqlite(@"Data Source=C:\Projetos\Rocketseat\Leilao\DB\leilaoDbNLW.db");
});
